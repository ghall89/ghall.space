...
It's been a few months since I launched my first iPhone app – a local-first music player called [Groove](https://apps.apple.com/app/groove-local-music-player/id6759224962) – and it's been an interesting journey. I thought it would be fun to reflect on some of the challenges and successes I've faced building the app, and my journey to continually improve it.
